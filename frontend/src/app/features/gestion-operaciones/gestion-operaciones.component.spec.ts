...
describe('GestionOperacionesComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [GestionOperacionesComponent],
      providers: [
        provideHttpClient(),
  ...
  it('debería crear el componente GestionOperacionesComponent', () => {
    const fixture = TestBed.createComponent(GestionOperacionesComponent);
