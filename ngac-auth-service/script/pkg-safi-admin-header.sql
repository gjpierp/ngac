CREATE OR REPLACE PACKAGE NGAC_USER.pkg_safi_admin AS
     ...
     * ==================================================================================================================================================
     */
    PROCEDURE crear_usuario(p_slug_usuario IN VARCHAR2, p_rut IN VARCHAR2, p_nombres IN VARCHAR2, p_apellidos IN VARCHAR2, p_email IN VARCHAR2, p_out_id OUT NUMBER);
    PROCEDURE desactivar_usuario(p_id_usuario IN NUMBER);
    PROCEDURE crear_unidad(p_slug_unidad IN VARCHAR2, p_nombre_unidad IN VARCHAR2, p_descripcion IN VARCHAR2, p_out_id OUT NUMBER);
    PROCEDURE crear_entidad(p_slug_entidad IN VARCHAR2, p_nombre_entidad IN VARCHAR2, p_tipo_entidad IN VARCHAR2, p_out_id OUT NUMBER);
    ...
    PROCEDURE p_upsert_safi_usuario(p_id IN NUMBER, p_nombre IN VARCHAR2, p_email IN VARCHAR2, p_estado IN NUMBER);
    PROCEDURE p_delete_safi_usuario(p_id IN NUMBER);

    PROCEDURE p_upsert_safi_entidad(p_id IN NUMBER, p_nombre IN VARCHAR2, p_slug IN VARCHAR2, p_desc IN VARCHAR2, p_estado IN NUMBER);
    PROCEDURE p_delete_safi_entidad(p_id IN NUMBER);

    PROCEDURE p_upsert_safi_unidad(p_id IN NUMBER, p_nombre IN VARCHAR2, p_slug IN VARCHAR2, p_desc IN VARCHAR2, p_estado IN NUMBER);
